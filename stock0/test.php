...
$user1_token = requestNotNull("localhost/stock0/reg/reg.php",
    array("login" => "user1", "password" => "123",), "token")["token"];
requestEquals("localhost/stock0/new_coin/new_coin.php",
    array("token" => $user1_token, "domain_name" => "HRP", "postfix_length" => 2), "added", 100);


$user2_token = requestNotNull("localhost/stock0/reg/reg.php",
...
requestEquals("localhost/stock0/pairs/trade/new_limit_request.php",
...
/*
requestEquals("localhost/stock0/api/account.php",
...
requestEquals("localhost/stock0/api/income.php",
...
requestEquals("localhost/stock0/api/limit.php",
...
requestEquals("localhost/stock0/api/requests.php",
...
$hrp_received = requestNotEquals("localhost/stock0/api/output.php",
    array(
        "token" => $user1_token,
        "domain_name" => "HRP",
        "output_count" => 1000,
